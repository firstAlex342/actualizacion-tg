...
namespace CapaAccesoDatos
{
    public class ClsParametros2
    {
        ...
        // C. Entrada de datos
        public ClsParametros2(string objNombre, object objValor)
        {
            Nombre = objNombre;
            Valor = objValor;
        ...
        // C. Salida de datos
        public ClsParametros2(String objNombre, SqlDbType objTipoDato, Int32 objTamano)
        {
            Nombre = objNombre;
