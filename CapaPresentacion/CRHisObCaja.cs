...
namespace CapaPresentacion {
    ...
    public class CRHisObCaja : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "CapaPresentacion.CRHisObCaja.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedCRHisObCaja : Component, ICachedReport {
        
        public CachedCRHisObCaja() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            CRHisObCaja rpt = new CRHisObCaja();
            rpt.Site = this.Site;
            return rpt;
        }
